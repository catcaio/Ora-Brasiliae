...
Para a comparação operacional linear vs quadrático (MPV-55), executar:
`python scripts/fitting_pipeline.py --input data/mpv55_visibility_synthetic.csv --output results/mpv55_fitting_report.json --tau 1.0`
